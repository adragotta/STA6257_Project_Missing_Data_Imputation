...
![](Screenshot%202024-03-16%20165449.png){width="627"}
...
4.  **Most Frequent Value Imputation \
    **Also known as mode imputation, this is when the most frequent
    value replaces the missing values.This can be the most frequent
    value or most frequent category. This also may enable
    over-representation of the frequent variable.
